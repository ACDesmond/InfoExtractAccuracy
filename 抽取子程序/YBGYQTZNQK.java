 ...
 * 原被告有其他子女情况
 */
public class YBGYQTZNQK {

    public Element extract(XWPFDocument doc, String text) {
        Element YBGYQTZNQK = DocumentHelper.createElement("YBGYQTZNQK");
        YBGYQTZNQK.addAttribute("nameCN", "祖父母或外祖父母因素");

        {
            Element YBGYWQTZN = YBGYQTZNQK.addElement("YBGYWQTZN").addAttribute("nameCN", "原告是否有无其他子女");
            String ifcz = getQTZN(text, "原告");
            YBGYWQTZN.addAttribute("value", ifcz);
        }
        {
            Element YBGYWQTZN = YBGYQTZNQK.addElement("YBGYWQTZN").addAttribute("nameCN", "被告是否有无其他子女");
            String ifcz = getQTZN(text, "被告");
            YBGYWQTZN.addAttribute("value", ifcz);
        }
