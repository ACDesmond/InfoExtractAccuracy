...
/**
 * 离婚时抚养权的决定方式
 * 离婚时抚养权的决定方式（双方协议 or 法院判决）
 */
public class LHSFYQJDFS {

    public Element extract(XWPFDocument doc, String text) {

        Element LHSFYQJDFS = DocumentHelper.createElement("LHSFYQJDFS");
        LHSFYQJDFS.addAttribute("nameCN", "离婚时抚养权的决定方式");
        ...
        LHSFYQJDFS.addAttribute("value", fyqjdfs);
        return LHSFYQJDFS;
